...
class Bola(pygame.sprite.Sprite):
	def __init__(self):
		...
		self.image = load_image("Sprites/teo.png", True)
...
class Pala(pygame.sprite.Sprite):
	def __init__(self, x):
		pygame.sprite.Sprite.__init__(self)
		self.image = load_image("Sprites/pala.png")
		self.rect = self.image.get_rect()
		self.rect.centerx = x
		self.rect.centery = HEIGHT / 2
		self.speed = 0.5
...
def main():
	...
	pygame.display.set_caption("Rebote del teo")

	bg = load_image('Sprites/bg1.jpg')
	bola = Bola()
	pala_jug = Pala(30)
